# Generated by Django 5.1.4 on 2025-01-30 15:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('attendance', '0002_payrollhistory'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clock_in', models.TimeField(auto_now=True, null=True)),
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='days_employeer', to='employeers.employeer')),
