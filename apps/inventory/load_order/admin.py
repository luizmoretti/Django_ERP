...
class LoadOrderAdmin(admin.ModelAdmin):
    ...
    list_display = ('order_number', 'load_date', 'created_at', 'updated_at', 'get_created_by_full_name', 'get_updated_by_full_name')
    list_filter = ('created_at', 'updated_at')
    search_fields = ('order_number', 'created_by__first_name', 'created_by__last_name', 'updated_by__first_name', 'updated_by__last_name')
